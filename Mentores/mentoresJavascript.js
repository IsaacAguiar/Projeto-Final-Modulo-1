    ...
    mentores.forEach((mentor) => {
        const mentorHtml = `
            <tr>
                <td>${mentor.nome}</td>
                <td>${mentor.email}</td>
                <td><svg onclick="editarMentor('${mentor.id}')" class="botoesFormulario" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg onclick="excluirMentor('${mentor.id}')" class="botoesFormulario" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
