    ...
    turmas.forEach((turma) => {
        const turmaHtml = `
            <tr style="border: 0px none; border-radius: 8px;">
                ...
                <td>${turma.dataSemana}</td>
                <td>${turma.horario}</td>
                <td>${turma.encontros}</td>
                <td>
                    <svg onclick="editarTurma(${turma.id})" class="botoesFormulario" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg onclick="excluirTurma('${turma.id}')" class="botoesFormulario" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        tabelaCorpo.innerHTML += turmaHtml; 
    });
};
