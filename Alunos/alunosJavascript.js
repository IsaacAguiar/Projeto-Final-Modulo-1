    ...
    alunos.forEach((aluno) => {
        const alunoHtml = `
            <tr>
                ...
                <td><svg onclick="editarAluno('${aluno.id}')" class="botoesFormulario" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg onclick="excluirAluno('${aluno.id}')" class="botoesFormulario" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        tabelaCorpo.innerHTML += alunoHtml;
    })
}
